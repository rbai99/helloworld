...
function submit_question(ques) {
    var dummy_data = new Buffer(8);
    var question_more = {
        question: ques,
        files:[{type:'pic', sub_type:'jpg', data:dummy_data},
                {type:'aud', sub_type:'pcm', data:dummy_data},
                {type:'vid', sub_type:'avi',data:dummy_data}],
    };
